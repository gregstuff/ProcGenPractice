...
namespace ProcGenSys.Editor.UI
{
    public class RuleCardUI
    {
        ...
        private static void HandleSpacingFields(DecorationRuleUIModel gridRule)
        {
            ...
            int sameCat = EditorGUILayout.IntField("Same Category Radius", gridRule.SameCategoryMinDistance);
            int samePf = EditorGUILayout.IntField("Same Prefab Radius", gridRule.SamePrefabMinDistance);
            int personal = EditorGUILayout.IntField("Personal Space Radius", gridRule.BlockRadiusDistance);

            gridRule.SameCategoryMinDistance = Mathf.Max(0, sameCat);
            gridRule.SamePrefabMinDistance = Mathf.Max(0, samePf);
            gridRule.BlockRadiusDistance = Mathf.Max(0, personal);
            GUILayout.EndVertical();
        }
