...
public class DungeonRoomGen : IDungeonLevelGenerator
{
    ...
    public Level GenerateDungeonLevel(GeneratedLevelLayoutSO levelConfig)
    {
        ...
        return AddRooms(levelConfig);
    }

    private void ValidateLevelLayout(GeneratedLevelLayoutSO levelConfig)
    {
        if (levelConfig.RoomTemplates.Count() == 0) throw new Exception("No room templates configured!");
    }
    ...
    private Level AddRooms(GeneratedLevelLayoutSO levelLayout)
    {
